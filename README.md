...
Back-end: Base sólida em Programação Orientada a Objetos (Java) e conhecimentos em PHP.
Dados: Experiência em SQL, incluindo comandos DDL/DML, consultas e integração Fullstack.
